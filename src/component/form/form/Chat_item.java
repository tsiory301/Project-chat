...
public class Chat_item extends javax.swing.JLayeredPane {
    ...
    public void setText(String text){
     ...
     public void setFile(String fileName, String fileSize) {
        ...
        layer.setBorder(new EmptyBorder(0, 5, 0, 5));
         Chat_Fike chatFile = new Chat_Fike();
    ...
    private void initComponents() {
        ...
        txt.setBorder(javax.swing.BorderFactory.createEmptyBorder(10, 10, 2, 10));
        txt.setSelectionColor(new java.awt.Color(102, 173, 230));
        add(txt);
