...
public class Chat_left8_Withe_Profil extends javax.swing.JLayeredPane {


    public Chat_left8_Withe_Profil() {
        initComponents();
    ...
    private void initComponents() {
        ...
        txt = new component.form.form.Chat_item();

        setLayout(new javax.swing.BoxLayout(this, javax.swing.BoxLayout.LINE_AXIS));

        IaImage.setBorderSize(0);
        IaImage.setImage(new javax.swing.ImageIcon(getClass().getResource("/icon/PRO.jpg"))); // NOI18N
    ...
    private component.form.form.Chat_item txt;
